...
class Network(nn.Module):
  ...
  def _predict(self, save=0):
    ...
    dynamic_filter_7 = F.tanh(self.dynamic_fc_7(hidden))
    dynamic_filter_7 = dynamic_filter_7.view(self._batch_size, -1, 1, 1) ####
    
    dynamic_filter_8 = F.tanh(self.dynamic_fc_8(hidden))
    dynamic_filter_8 = dynamic_filter_8.view(self._batch_size, -1, 1, 1) ####
    
    dynamic_filter_9 = F.tanh(self.dynamic_fc_9(hidden))
    dynamic_filter_9 = dynamic_filter_9.view(self._batch_size, -1, 1, 1) ####
    ...
    mask_1[:, :, :int(mask_1.size(2)/3), :int(mask_1.size(3)/3)] = 1
    ...
    mask_2[:, :, :int(mask_2.size(2)/3), int(mask_2.size(3)/3):int(mask_2.size(3)*2/3)] = 1
    ...
    mask_3[:, :, :int(mask_3.size(2)/3), :int(mask_3.size(3)/3)] = 1
    ...
    mask_4[:, :, int(mask_4.size(2)/3):int(mask_4.size(2)*2/3), :int(mask_4.size(3)/3)] = 1
    ...
    mask_5[:, :, int(mask_5.size(2)/3):int(mask_5.size(2)*2/3), int(mask_5.size(3)/3):int(mask_5.size(3)*2/3)] = 1
    ...
    mask_6[:, :, int(mask_6.size(2)/3):int(mask_6.size(2)*2/3), :int(mask_6.size(3)/3)] = 1
    net_conv_6 = net_conv * mask_6
    response_6 = F.conv2d(net_conv_6, dynamic_filter_6) ####
    
    mask_7 = Variable(torch.zeros(1, 1, net_conv.size(2), net_conv.size(3)).cuda())
    mask_7[:, :, int(mask_7.size(2)*2/3):, :int(mask_7.size(3)/3)] = 1
    net_conv_7 = net_conv * mask_7
    response_7 = F.conv2d(net_conv_7, dynamic_filter_7) ####
    
    mask_8 = Variable(torch.zeros(1, 1, net_conv.size(2), net_conv.size(3)).cuda())
    mask_8[:, :, int(mask_8.size(2)*2/3):, int(mask_8.size(3)/3):int(mask_8.size(3)*2/3)] = 1
    net_conv_8 = net_conv * mask_8
    response_8 = F.conv2d(net_conv_8, dynamic_filter_8) ####
    
    mask_9 = Variable(torch.zeros(1, 1, net_conv.size(2), net_conv.size(3)).cuda())
    mask_9[:, :, int(mask_9.size(2)*2/3):, :int(mask_9.size(3)/3)] = 1
    net_conv_9 = net_conv * mask_9
    response_9 = F.conv2d(net_conv_9, dynamic_filter_9) ####
    
    response = torch.cat((response_0, response_1, response_2, response_3, response_4, response_5, response_6, response_7, response_8, response_9), 1)
    response = self.response_net(response)
