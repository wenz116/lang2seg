...
class RNNEncoder(nn.Module):
  ...
  def forward(self, input_labels):
    ...
    Outputs:
    - output  : Variable float (batch, max_len, hidden_size * num_dirs) (3xxL, 10L, 1024L)
    - hidden  : Variable float (batch, num_layers * num_dirs * hidden_size) (3xxL, 1024L)
    - embedded: Variable float (batch, max_len, word_vec_size) (3xxL, 10L, 512L)
    """
