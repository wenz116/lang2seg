...
class JointMatching(nn.Module):
  ...
  def __init__(self, opt):
    ...
    self.dynamic_fc = nn.Linear(num_layers * num_dirs * hidden_size, opt['mask_feat_dim'])
  ...
  def forward(self, pool5, fc7, mask_feat, labels):
    """
    Inputs:
    ...
    response = F.conv2d(mask_feat, dynamic_filter)
