...
def test_net(net, imdb, weights_filename, max_per_image=100, thresh=0.):
  ...
  #print('num_images:', num_images) # 5000
  #print('imdb.num_classes:', imdb.num_classes) # 81
  #print('weights_filename:', weights_filename) # notime/res101_mask_rcnn_iter_1250000
  #print('imdb.image_path_at(0):', imdb.image_path_at(0)) # /4TB/ywchen/MAttNet/pyutils/mask-faster-rcnn/data/coco/images/val2014/COCO_val2014_000000532481.jpg
