...
# mrcn path
from model.train_val_vgg import get_training_roidb, train_net
...
def main(args):
  ...
  opt['C4_feat_dim'] = 512 ####
  net = vgg16(opt, batch_size=opt['batch_size']) # determine batch size in opt.py
  ...
  train_net(net, loader, output_dir, tb_dir,
            pretrained_model='pyutils/mask-faster-rcnn/output/vgg16/coco_2014_train+coco_2014_valminusminival/vgg16_faster_rcnn_iter_1190000.pth',
