...
class resnetv1(Network):
  ...
  def _init_modules(self):
    ...
    self.dynamic_fc_7 = nn.Linear(self._rnn_num_layers * self._rnn_num_dirs * self._rnn_hidden_size, self._C4_feat_dim)
    self.dynamic_fc_8 = nn.Linear(self._rnn_num_layers * self._rnn_num_dirs * self._rnn_hidden_size, self._C4_feat_dim)
    self.dynamic_fc_9 = nn.Linear(self._rnn_num_layers * self._rnn_num_dirs * self._rnn_hidden_size, self._C4_feat_dim)
    
    self.response_fc = nn.Linear(self._rnn_num_layers * self._rnn_num_dirs * self._rnn_hidden_size, 10)
